...
MapGroup4:
	map NewBarkTown, TILESET_ISLAND_TRADITIONAL, TOWN, SIGN_WOOD, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, 0, PALETTE_AUTO
...
MapGroup5:
	...
	map CollumitoBeach, TILESET_ISLAND_TRADITIONAL, TOWN, SIGN_WOOD, NEW_BARK_TOWN, MUSIC_BUG_CATCHING_CONTEST, 0, PALETTE_AUTO
	map Route1, TILESET_ISLAND_TRADITIONAL, ROUTE, SIGN_ROUTE, ROUTE_29, MUSIC_ROUTE_4_BW, 0, PALETTE_AUTO
	map GulleyTown, TILESET_ISLAND_TRADITIONAL, TOWN, SIGN_WOOD, VIOLET_CITY, MUSIC_WHITE_TREEHOLLOW_W2, 0, PALETTE_AUTO
	map Route2, TILESET_ISLAND_TRADITIONAL, ROUTE, SIGN_ROUTE, ROUTE_30, MUSIC_ROUTE_4_BW, 0, PALETTE_AUTO
