...
tileset_maps = {
'island_traditional': 'BellchimeTrail CherrygroveBay CherrygroveCity DragonsDenB1F EcruteakCity MagnetTunnelEast MahoganyTown NewBarkTown Route26 Route27 Route28 Route29 Route30 Route31 Route32 Route32Coast Route35 Route36 Route37 Route42 Route44 SilverCaveOutside VioletCity VioletOutskirts'.split(),
'island_modern': 'CianwoodCity GoldenrodCity GoldenrodHarbor MagnetTunnelWest OlivineCity OlivineCityRoute35CoastDual Route34 Route34Coast Route35CoastNorth Route35CoastSouth Route38 Route39 Route40 Route41 StormyBeach'.split(),
